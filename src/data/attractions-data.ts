...
export const deportes: Attraction[] = [
  {
    ...
    image: '/assets/attractions/futbol.webp',
    category: 'deportes',
    icon: '⚽',
  ...
  },
  {
    ...
    image: '/assets/attractions/voley.webp',
    category: 'deportes',
    icon: '🏐',
  ...
  },
  {
    ...
    image: '/assets/attractions/basquetbol.webp',
    category: 'deportes',
    icon: '🏀',
  ...
  },
  {
    ...
    image: '/assets/attractions/tenis.webp',
    category: 'deportes',
    icon: '🎾',
  ...
  },
  {
    ...
    image: '/assets/attractions/padel.webp',
    category: 'deportes',
    icon: '🎾',
    capacity: '4 jugadores',
    badge: 'Nuevo'
  },
  {
    ...
    image: '/assets/attractions/natacion.webp',
    category: 'deportes',
    icon: '🏊',
    duration: '45 minutos'
  },
  {
    ...
    image: '/assets/attractions/funcional.webp',
    category: 'deportes',
    icon: '💪',
    capacity: '15 personas'
  },
  {
    ...
    image: '/assets/attractions/gimnasio.webp',
    category: 'deportes',
    icon: '🏋️',
...
export const gastronomia: Attraction[] = [
  {
    ...
    image: '/assets/attractions/restaurante-lago.webp',
  ...
  },
  {
    ...
    image: '/assets/attractions/bar-acuatico.webp',
    category: 'gastronomia',
    icon: '🍹',
  ...
  },
  {
    ...
    image: '/assets/attractions/patio-comidas.webp',
    category: 'gastronomia',
    icon: '🍕',
...
export const kidsZone: Attraction[] = [
  {
    ...
    image: '/assets/attractions/salon-juegos.webp',
    category: 'kids',
    icon: '🎮',
    capacity: '30 niños',
    badge: 'Popular'
  },
  {
    ...
    image: '/assets/attractions/castillo-infantil.webp',
    category: 'kids',
    icon: '🏰',
    capacity: '25 niños',
    badge: 'Favorito'
  },
  {
    ...
    image: '/assets/attractions/playa-ninos.webp',
    category: 'kids',
    icon: '🏖️',
    capacity: '40 niños'
  },
  {
    ...
    image: '/assets/attractions/body-slide-kids.webp',
    category: 'kids',
    icon: '🎢',
    capacity: '20 niños',
    badge: 'Seguro'
...
export const bungalowsAmenities: Attraction[] = [
  ...
  },
  {
    ...
    image: '/assets/attractions/salon-spa-vip.webp',
    category: 'bungalows',
    icon: '✨',
    badge: 'VIP'
  },
  {
    ...
    image: '/assets/attractions/cancha-cubierta.webp',
    category: 'bungalows',
    icon: '🏆',
    badge: 'Techada',
    capacity: '12 jugadores'
  },
  {
    ...
    image: '/assets/attractions/salon-convivencia.webp',
    category: 'bungalows',
    icon: '👥',
    badge: 'Social',
    capacity: '50 personas'
  },
  {
    ...
    image: '/assets/attractions/gimnasio-vip.webp',
    category: 'bungalows',
    icon: '💪',
    badge: 'Equipado',
  ...
  },
  {
    ...
    image: '/assets/attractions/sala-cine.webp',
    category: 'bungalows',
    icon: '🎬',
    badge: 'HD 4K',
    capacity: '30 personas'
  },
  {
    ...
    image: '/assets/attractions/bar-restaurante-vip.webp',
    category: 'bungalows',
    icon: '🍽️',
    badge: 'Gourmet',
    capacity: '40 personas'
  },
  {
    ...
    image: '/assets/attractions/parrilla-privada.webp',
    category: 'bungalows',
    icon: '🔥',
    badge: 'Quincho'
  },
  {
    ...
    image: '/assets/attractions/salon-eventos.webp',
    category: 'bungalows',
    icon: '🎉',
    badge: 'Fiestas',
    capacity: '80 personas'
  ...
  },
  {
    ...
    image: '/assets/attractions/senderismo.webp',
    category: 'bungalows',
    icon: '🌲',
    badge: 'Naturaleza',
    duration: '30-45 min'
