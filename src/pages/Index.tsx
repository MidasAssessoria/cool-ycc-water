  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[60vh] sm:h-[70vh] md:h-[85vh] min-h-[500px] sm:min-h-[600px] overflow-hidden pt-[64px] sm:pt-[72px] lg:pt-[80px]">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 py-2 sm:px-4 sm:py-2 bg-coral/90 backdrop-blur-sm rounded-full text-white text-xs sm:text-sm font-semibold mb-3 sm:mb-4 md:mb-6 animate-fade-in shadow-lg min-h-[36px]" role="status" aria-label="El mayor parque acuático del Paraguay">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-8">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                <li>
                  <button onClick={() => scrollToSection('attractions')} className="text-white/70 hover:text-white active:text-white/90 transition-colors text-sm text-left py-2 min-h-[44px] w-full touch-manipulation">
                    Atracciones
                  </button>
                </li>
                <li>
                  <button onClick={() => window.location.href = '/membresias'} className="text-white/70 hover:text-white active:text-white/90 transition-colors text-sm text-left py-2 min-h-[44px] w-full touch-manipulation">
                    Membresías
                  </button>
                </li>
                <li>
                  <button onClick={() => scrollToSection('booking')} className="text-white/70 hover:text-white active:text-white/90 transition-colors text-sm text-left py-2 min-h-[44px] w-full touch-manipulation">
                    Tour VIP guiado
                  </button>
                </li>
                <li>
                  <button onClick={() => scrollToSection('bungalows')} className="text-white/70 hover:text-white active:text-white/90 transition-colors text-sm text-left py-2 min-h-[44px] w-full touch-manipulation">
                    Bungalows
                  </button>
                </li>
                <li>
