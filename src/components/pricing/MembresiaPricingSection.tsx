  ...
  return (
    ...
    >
      ...
      <TimelineContent
        ...
        className="absolute top-0 h-96 w-screen overflow-hidden [mask-image:radial-gradient(ellipse_50%_50%_at_center,white,transparent)]"
      >
        ...
        <SparklesComp
          ...
          speed={1}
          color="#0ea5e9"
          className="absolute inset-x-0 bottom-0 h-full w-full [mask-image:radial-gradient(ellipse_50%_50%_at_center,white,transparent_85%)]"
        />
      </TimelineContent>
