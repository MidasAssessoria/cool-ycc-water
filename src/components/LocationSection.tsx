...
const LocationSection = () => {
  ...
  useEffect(() => {
    ...
    script.text = JSON.stringify({
      ...
      "name": "YCC Water Park",
      "description": "O maior parque aquático da região com mais de 25 hectáreas de diversão para toda a família",
      ...
      <div className="container max-w-7xl mx-auto">
        ...
        <header className="text-center mb-10 sm:mb-12 lg:mb-16">
          ...
          <p className="text-sm sm:text-base md:text-lg text-muted-foreground max-w-2xl mx-auto px-4">
            Encontre YCC Water Park no coração de Ypané, Paraguay
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 sm:gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-3" role="complementary" aria-label="Mapa e informações de localização">
            {/* Map Container */}
            <div className="map-wrapper relative rounded-xl overflow-hidden shadow-2xl mb-6 animate-fade-in transition-all duration-300 hover:shadow-[0_20px_50px_rgba(0,0,0,0.15)]">
              ...
              <iframe 
                ...
                title="Mapa de localização YCC Water Park em Ypané, Paraguay"
                aria-label="Mapa interativo mostrando a localização do YCC Water Park em Ypané, Paraguay. Use as teclas de seta para navegar pelo mapa."
            ...
            >
              <div className="icon-wrapper flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 bg-primary/10 rounded-full flex-shrink-0 transition-transform duration-200 group-hover:scale-110">
                <svg 
                  ...
                  role="img"
                >
                  <title>Ícone de localização</title>
          ...
          <div className="lg:col-span-2 space-y-5 sm:space-y-6" role="complementary" aria-label="Informações de horários e transporte">
            ...
            >
              <h3 id="schedule-title" className="text-lg sm:text-xl font-bold text-foreground mb-4 flex items-center gap-2">
                ...
                <span>Horários de Visita</span>
              </h3>
              <div className="schedule space-y-3" role="list" aria-label="Horários de funcionamento">
                <div className="day-item flex justify-between items-center py-3 border-b border-border" role="listitem">
                  <span className="font-medium text-foreground text-sm sm:text-base">Sábados e Domingos</span>
                  <span className="font-bold text-primary text-base sm:text-lg" aria-label="Horário de 8 horas da manhã às 18 horas da tarde">8:00 - 18:00</span>
                </div>
                <div className="note flex items-start gap-2 bg-primary/5 p-3 rounded-lg mt-4" role="note" aria-label="Informação importante">
            ...
            <article 
              ...
              tabIndex={0}
            >
              <h3 id="transport-title" className="text-lg sm:text-xl font-bold text-foreground mb-4">Como Chegar</h3>
              
              <div role="list" aria-label="Opções de transporte">
                {/* Opção 1: Carro */}
                <div 
                  ...
                  role="listitem"
                  tabIndex={0}
                  aria-label="Opção de transporte de automóvel"
                >
                  ...
                  <div className="transport-content">
                    <h4 className="font-semibold text-foreground mb-1 text-sm sm:text-base">De Automóvel</h4>
                    <p className="text-xs sm:text-sm text-muted-foreground mb-1">Desde Asunción: 30 minutos pela Ruta 2</p>
                    <p className="text-xs sm:text-sm text-muted-foreground/80">Estacionamento gratuito disponível</p>
                  </div>
                </div>
                ...
                <div 
                  ...
                  role="listitem"
                  tabIndex={0}
                  aria-label="Opção de transporte público"
                >
                  <div className="icon-wrapper flex-shrink-0 mt-1">
                  ...
                  <div className="transport-content">
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground mb-1">Linhas de ônibus para Ypané</p>
                ...
                <div 
                  ...
                  role="listitem"
                  tabIndex={0}
                  aria-label="Opção de transporte do aeroporto"
                >
                  <div className="icon-wrapper flex-shrink-0 mt-1">
                  ...
                  <div className="transport-content">
                    <h4 className="font-semibold text-foreground mb-1 text-sm sm:text-base">Do Aeroporto</h4>
                    <p className="text-xs sm:text-sm text-muted-foreground mb-1">Aeroporto Silvio Pettirossi: 45 minutos</p>
                    <p className="text-xs sm:text-sm text-muted-foreground/80">Táxi ou transfer disponível</p>
                  </div>
                </div>
              </div>
            </article>
            ...
            <div className="contact-actions space-y-3 animate-fade-in" style={{ animationDelay: '400ms' }} role="navigation" aria-label="Ações de contato e navegação">
              <button 
                ...
                aria-label="Abrir localização do YCC Water Park no Google Maps em nova aba"
                type="button"
              >
              ...
              <button 
                ...
                aria-label="Solicitar serviço de transfer para o YCC Water Park"
                type="button"
              >
